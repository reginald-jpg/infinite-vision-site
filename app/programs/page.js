...
export default function ProgramsIndexPage() {
  return (
    <InnerPageShell
      ...
      breadcrumbs={
        <>
          <CrumbLink href="/">Home</CrumbLink> / Programs
        </>
      }
      lead="Infinite Vision is veteran-led and mission-driven. Our model aligns housing, transportation, financial empowerment, and community integration so veterans and their families can stabilize and move forward."
    >
